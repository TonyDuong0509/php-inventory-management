                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Roles Page</h4><br><br>
                                    <a href="/all-roles" style="color: grey;">
                                        <p style="text-align: end;"><- Back to roles</p>
                                    </a>
                                    <form method="POST" action="/update-role" id="myForm">
                                        <input type="hidden" name="id" value="<?= $role->getId(); ?>">
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Role Name </label>
                                            <div class="form-group col-sm-10">
                                                <input name="name" class="form-control" type="text" value="<?= $role->getName(); ?>">
                                            </div>
                                        </div>
                                        <div class="text-end">
