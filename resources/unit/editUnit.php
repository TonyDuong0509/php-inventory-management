                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="/all-units" style="color: grey;">
                                        <p style="text-align: end;"><- Back to units</p>
                                    </a>
                                    <form method="POST" action="<?php echo $router->generate('update.unit'); ?>" id="myForm">
                                        <input type="hidden" name="unitId" value="<?php echo $unit->getId(); ?>">
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Unit Name </label>
                                            <div class="form-group col-sm-10">
                                                <input name="name" class="form-control" type="text" value="<?php echo $unit->getName(); ?>">
                                            </div>
                                        </div>
                                        <div class="text-end">
