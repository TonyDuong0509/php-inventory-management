...
<head>
    <meta charset="utf-8" />
    <title>Inventory - Active Account</title>
        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <h1 class="text-muted text-center font-size-18">Sign up successfully. Please check your email to activate your account.</h1>
                    <!-- end -->
                </div>
                <!-- end cardbody -->
            </div>
